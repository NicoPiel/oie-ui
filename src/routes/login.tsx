...
export function LoginComponent() {
    ...
    async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        startTransition(async () => {
            const { data, error } = await auth.api.signInUsername({
                body: {
                    username,
                    password,
    ...
    return (
        <div className="min-h-svh grid place-items-center bg-gradient-to-b from-background to-muted/50 px-4">
                ...
                <CardHeader className="space-y-2">
                    <div className="flex items-center gap-2">
                        ...
                        <CardTitle className="text-xl">
                            Sign in to Mirth Modern UI
                        </CardTitle>
                    </div>
                    <CardDescription>
                        Use your Mirth credentials. Your session stays on the
                        server.
                    </CardDescription>
                </CardHeader>
